...
const form = createForm({
  effects(form) {
    ...
    onFieldValueChange('goodStatus', (field) => {
      //
      const selectValue1 = field.value
      const selectValue2 = form.query('goodStatus').value()

      // ---------- 获取当前监听的表单项的数据 -------------
      console.log('获取监听的表单项的Value：' + field.value)
      console.log('获取监听的表单项的visible：' + field.visible)
